const { Message, MessageEmbed, MessageButton, MessageActionRow, Permissions } = require("discord.js");
    ...
    switch (s.loadType) {
        case "TRACK_LOADED":
            ...
            const embed = new MessageEmbed()
                .setDescription(`🔹 |  Enqueued **[${res.tracks[0].title}](${res.tracks[0].uri})** [${convertTime(res.tracks[0].duration) || "Undetermined"} - ${user}]`)
